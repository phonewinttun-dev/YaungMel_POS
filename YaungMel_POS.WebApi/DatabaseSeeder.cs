    ...
    public static async Task SeedAsync(IServiceProvider serviceProvider)
    {
        ...
        if (!await db.Products.AnyAsync())
        {
            ...
            var sampleImages = new[]
            {
                ...
                new { Name = "Baileys", Id = "yaungmel_pos_product_photos/baileys_znjpp9", Url = "https://res.cloudinary.com/demo/image/upload/v1/yaungmel_pos_product_photos/baileys.jpg" },
                ...
                new { Name = "Malibu", Id = "yaungmel_pos_product_photos/malibu_originalnew750_egbuid", Url = "https://res.cloudinary.com/demo/image/upload/v1/yaungmel_pos_product_photos/jagermeister.jpg" },
